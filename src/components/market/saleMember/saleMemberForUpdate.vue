  ...
  <div>
    <div :style="this.mainStyle">
      <el-form :model="insertForm" :rules="insertFormRules"  ref="insertForm" v-loading="loading" :inline="false" label-position="right" label-width="170px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="售电公司编码：" prop="memberCode">
              <el-input :disabled="ifDisable" v-model="insertForm.memberCode" placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="使用协议书编号：" prop="agreementCode">
              <el-input :disabled="ifDisable" v-model="insertForm.agreementCode" placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="售电公司名称：" prop="memberName">
              <el-input :disabled="ifDisable" v-model="insertForm.memberName" placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="售电公司类型：" prop="memberType">
              <el-select :disabled="ifDisable" clearable v-model="insertForm.memberType" placeholder="请选择">
                <el-option v-for="item in props.selectData.MEMBER_TYPE_SDGS" :key="item.enumItemCode" :label="item.enumItemName" :value="item.enumItemCode"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="售电公司简称：" prop="shortName">
              <el-input :disabled="ifDisable" v-model="insertForm.shortName" placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="代理负荷容量：" prop="proxyCapacity">
              <el-input v-model="insertForm.proxyCapacity" placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="统一社会信用代码：" prop="socialCode">
              <el-input :disabled="ifDisable" v-model="insertForm.socialCode" placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="地理区域：" prop="geogRegion">
              <el-input :disabled="ifDisable" v-model="insertForm.geogRegion" clearable @focus="areaFocus('geo')" placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="控制区域：" prop="controlRegion">
              <el-input :disabled="ifDisable" v-model="insertForm.controlRegion" clearable @focus="areaFocus('con')" placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="购(售)电层级：" prop="buyLevel">
              <el-select :disabled="ifDisable" clearable v-model="insertForm.buyLevel" placeholder="请选择">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="购(售)电结算单位：" prop="settleCompanyId">
              <el-input :disabled="ifDisable" v-model="insertForm.settleCompanyId" placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="开户银行：" prop="acctBankName">
              <el-input :disabled="ifDisable" v-model="insertForm.acctBankName" placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="开户名称：" prop="acctName">
              <el-input :disabled="ifDisable" v-model="insertForm.acctName" placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="银行账号：" prop="acctCode">
              <el-input :disabled="ifDisable" v-model="insertForm.acctCode" placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="增值税率：" prop="taxRate">
              <el-input :disabled="ifDisable" v-model="insertForm.taxRate" placeholder="请输入">
...
export default {
  ...
  data () {
    return {
      ...
      insertFormRules: {
        memberCode: [
          { required: true, message: '请输入售电公司编码', trigger: ['blur', 'change'] },
        ...
        memberName: [
          { required: true, message: '请输入售电公司名称', trigger: ['blur', 'change'] },
  ...
  methods: {
    ...
    memberFocus: function () {
      _this.$layer.iframe({
        ...
        content: {
          ...
          parent: this,
          data: {classType: '03', classTypeDisabled: true}
        },
        close: function (obj) {
    ...
    remoteSaleMember (query) {
      ...
      _this.$commonUtil.execCheckFunction(_this, 'queryData', function () {
        ...
        _this.queryPowerField.classType = '03'
    ...
    insert: function (formName) {
      let mainData = _this.$commonUtil.objectToUpdateData(_this.insertForm, this.props.insertForm, 'id')
      _this.$curdUtil.saveOrUpdate(_this, insertUrl, mainData, formName).then((res) => {
  ...
  created: function () {
    ...
    // 添加网关
    _this.gateway_url = _this.$Config.gateway_module.common
    _this.props.insertForm.superiorUnitName = _this.props.insertForm.superiorUnitName == null ? null : _this.props.insertForm.superiorUnitName
    _this.insertForm = _this.$commonUtil.deepClone(_this.props.insertForm)
    _this.ifDisable = _this.props.ifDisable
    if (_this.ifDisable) {
      if (_this.insertForm.memberStatus) {
        _this.insertForm.memberStatus = _this.insertForm.memberStatus
      } else {
        _this.insertForm.memberStatus = '01'
      }
      this.insertFormRules.memberStatus = [
        { required: true, message: '请选择市场成员状态', trigger: ['blur', 'change'] }
      ]
    }
    // 初始化页面布局
    _this.$commonUtil.initStyleLayer(_this)
    _this.selectSaleData = [
      {
        id: _this.insertForm.superiorUnit,
        memberName: _this.insertForm.superiorUnitName
      }
    ]
  }
}
