      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="用户供电电压等级：" prop="voltageGrade">
            <el-select clearable v-model="insertForm.voltageGrade" placeholder="">
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="报装容量：" prop="newspaperCapacity">
            <el-input v-model="insertForm.newspaperCapacity">
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="最大需量：" prop="zdxl">
            <el-input v-model="insertForm.zdxl">
              <template slot="append">千千瓦</template>
            </el-input>
          </el-form-item>
        </el-col>
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="购(售)电层级：" prop="buyLevel">
            <el-select clearable v-model="insertForm.buyLevel" placeholder="">
