        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="隶属集团名称：" prop="companyId">
              <el-select :disabled="ifDisable" clearable v-model="insertForm.companyId" placeholder="请选择">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="电厂性质：" prop="powerPlantType">
              <el-select :disabled="ifDisable" clearable v-model="insertForm.powerPlantType" placeholder="请选择">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="银行联行号：" prop="acctLiaison">
              <el-input :disabled="ifDisable" v-model="insertForm.acctLiaison" placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="使用协议书编号：" prop="agreementCode">
              <el-input :disabled="ifDisable" v-model="insertForm.agreementCode" placeholder="请输入">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
