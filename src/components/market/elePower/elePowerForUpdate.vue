  ...
  <div>
    <div :style="this.mainStyle">
      <el-form :model="insertForm" :rules="insertFormRules" ref="insertForm" :inline="false" label-position="right" label-width="170px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="电网公司名称：" prop="memberName">
              <el-input v-model="insertForm.memberName" placeholder="请输入" :disabled="ifDisable"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="电网公司简称：" prop="shortName">
              <el-input v-model="insertForm.shortName" placeholder="请输入" :disabled="ifDisable"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="电网公司类型：" prop="memberType">
              <el-select clearable v-model="insertForm.memberType" >
                <el-option v-for="item in props.selectData.MEMBER_TYPE_DWGS" :key="item.enumItemCode" :label="item.enumItemName" :value="item.enumItemCode"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="开户银行：" prop="acctBankName">
              <el-input v-model="insertForm.acctBankName" placeholder="请输入" :disabled="ifDisable"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="开户名称：" prop="acctName">
              <el-input v-model="insertForm.acctName" placeholder="请输入" :disabled="ifDisable"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="银行账号：" prop="acctCode">
              <el-input v-model="insertForm.acctCode" placeholder="请输入" :disabled="ifDisable"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
export default {
  ...
  data () {
    return {
      ...
      insertFormRules: {
        memberCode: [
          { required: true, message: '电网公司编码为空，请检查', trigger: ['blur', 'change'] },
        ...
        memberName: [
          { required: true, message: '电网公司名称为空，请检查', trigger: ['blur', 'change'] },
        ...
        memberType: [
          { required: true, message: '请选择电网公司类型', trigger: 'blur' }
        ],
        memberTypeName: [
          { required: true, message: '请选择电网公司类型', trigger: 'blur' }
        ],
  ...
  methods: {
    ...
    memberFocus: function () {
      _this.$layer.iframe({
        ...
        content: {
          ...
          parent: this,
          data: {classType: '02', classTypeDisabled: true}
        },
        close: function (obj) {
    ...
    remoteSaleMember (query) {
      ...
      _this.$commonUtil.execCheckFunction(_this, 'queryData', function () {
        ...
        _this.queryPowerField.classType = '02'
  ...
  mounted: function () {
    if (_this.insertForm.dataStatus === '02') {
